...
function App() {
  ...
  return (
    <div className='flex justify-center items-center h-screen bg-[hsl(185,75%,39%)] relative overflow-hidden'>
      <img src="/assets/bg-pattern-top.svg" alt="bg top pattern" className='absolute -top-[80%] -left-[40%]' />
      <img src="/assets/bg-pattern-bottom.svg" alt="bg bottom pattern" className='absolute -bottom-[80%] -right-[40%]' />
